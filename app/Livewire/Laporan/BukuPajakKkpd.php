...
", [$bulan, $tahun, $this->jenis, $bulan, $tahun, $this->jenis]);
    ...
    private function hitungTotalPajak($tahun, $bulan)
    {
        ...
        $this->ppnTotal = DB::table('pajak_kkpds')
            ...
            ->whereMonth('belanja_kkpds.tanggal', $bulan)
            ->whereYear('belanja_kkpds.tanggal', $tahun)
    ...
    private function hitungPajakBulanIni($tahun, $bulan)
    {
        ...
        $data->whereMonth('belanja_kkpds.tanggal', $bulan)
            ->whereYear('belanja_kkpds.tanggal', $tahun);
        $this->pajakBulanIni = $data->sum('pajak_kkpds.nominal');
    }
    ...
    private function hitungPajakBulanLalu($tahun, $bulan)
    {
        if ($bulan === 1) {
            ...
            $data->whereMonth('belanja_kkpds.tanggal', 12)
                ->whereYear('belanja_kkpds.tanggal', $tahun - 1);
            $this->pajakBulanLalu = $data->sum('pajak_kkpds.nominal');
        } else {
