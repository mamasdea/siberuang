...
<div>
    <div class="modern-card fade-in-up">
        <div class="card-header-modern">
            <h3 class="page-title">Buku Pembantu Pajak (LS)</h3>
            <p class="page-subtitle mb-0">Laporan pemotongan dan penyetoran pajak LS</p>
        </div>
            ...
            @if ($tanggal_awal && $tanggal_akhir)
                <div class="bg-white p-4 border rounded" id="print-area">
                    <div class="text-center mb-4">
                        ...
                        <h3 class="font-weight-bold mb-1">BUKU PEMBANTU PAJAK (LS)</h3>
                        @if ($jenis === 'PPN')
