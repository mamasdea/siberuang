...
<div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="formPotonganPajakModalLabel">
                        {{ $updateMode ? 'Edit Potongan Pajak LS' : 'Tambah Potongan Pajak LS' }}
                    </h4>
    ...
    <!-- Tabel Potongan Pajak LS -->
    <div class="modern-card fade-in-up">
        <div class="card-header-modern">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h3 class="page-title">Daftar Potongan Pajak LS</h3>
                    <p class="page-subtitle mb-0">Kelola data potongan pajak untuk belanja langsung (LS)</p>
                </div>
                <div>
                    <button class="btn btn-modern-add" wire:click="closeFormPajak" data-toggle="modal"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <span class="code-badge">SPM-{{ $no_bukti }}/Diskominfo/{{ date('Y') }}</span>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <small class="text-muted d-block mb-1">Total Nilai Belanja</small>
                    ...
                    <tbody>
                        @forelse ($pajaks as $pajak)
                            <tr>
                                ...
                                <td>
                                    <div class="mb-1"><strong>ID Billing:</strong> {{ $pajak->no_billing ? $pajak->no_billing : '-' }}</div>
                                    <div class="mb-1"><strong>NTPN:</strong> {{ $pajak->ntpn ? $pajak->ntpn : '-' }}</div>
                                    <div><strong>NTB:</strong> {{ $pajak->ntb ? $pajak->ntb : '-' }}</div>
                                </td>
                                <td class="text-right">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    ...
                                    <p class="mb-0 mt-2 text-muted">Belum ada data potongan pajak LS</p>
                                    <small class="text-muted">Klik tombol "Tambah Pajak LS" untuk menambah data</small>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
