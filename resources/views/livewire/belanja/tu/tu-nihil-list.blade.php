...
<div>
    <div class="modern-card fade-in-up">
        <div class="card-header-modern">
            ...
            <p class="page-subtitle mb-0">Daftar SPP-SPM TU yang sudah di-SPJ — pilih untuk setor sisa ke Kasda</p>
        </div>
                    ...
                    <tbody>
                        @forelse($sppSpmTus as $row)
                            ...
                            <tr wire:key="{{ $row->id }}">
                                ...
                                <td class="text-right font-weight-bold" style="white-space: nowrap; color: {{ $sisa > 0 ? '#dc2626' : '#16a34a' }};">
                                ...
                                <td class="text-center">
                                    ...
                                    @else
                                        <span class="badge badge-success" style="font-size: 9px;">0</span>
                                    @endif
                                </td>
                                <td class="text-center">
                                    @if($sisa > 0)
                                        <a href="{{ url('tu-nihil/' . $row->id) }}" class="btn btn-sm {{ $hasNihil ? 'btn-dark' : 'btn-warning' }}" style="border-radius: 6px; font-size: 10px; padding: 3px 8px;">
                        ...
                        @empty
                            <tr><td colspan="9" class="text-center text-muted py-4"><i class="fas fa-inbox fa-2x mb-2 d-block"></i>Belum ada SPP-SPM TU yang sudah di-SPJ</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
