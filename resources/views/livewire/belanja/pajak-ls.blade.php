    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="card-title">Daftar Potongan Pajak LS</h3>
                <div>
                    <button class="btn btn-outline-primary btn-sm" wire:click="closeFormPajak" data-toggle="modal"
                        data-target="#formPotonganPajakModal"><i class="fas fa-plus"></i>
                        Tambah Pajak LS</button>
                    <a href="{{ url('belanja_ls') }}" class="btn btn-outline-success btn-sm ml-2"><i
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning btn-sm text-white"
                                    ...
                                    data-target="#formPotonganPajakModal" title="Edit">
                                    <i class="fas fa-pencil-alt"></i>
                                </button>
                                <button class="btn btn-danger btn-sm"
                                    wire:click="delete_confirmation({{ $pajak->id }})" title="Hapus">
