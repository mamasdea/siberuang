@php
    ...
    if (!function_exists('tbgls')) {
        function tbgls($n): string
        {
            ...
            if ($n < 20) {
                return trim(tbgls($n - 10) . ' belas');
            }
            if ($n < 100) {
                return trim(tbgls((int) ($n / 10)) . ' puluh ' . tbgls($n % 10));
            }
            if ($n < 200) {
                return trim('seratus ' . tbgls($n - 100));
            }
            if ($n < 1000) {
                return trim(tbgls((int) ($n / 100)) . ' ratus ' . tbgls($n % 100));
            }
            if ($n < 2000) {
                return trim('seribu ' . tbgls($n - 1000));
            }
            if ($n < 1000000) {
                return trim(tbgls((int) ($n / 1000)) . ' ribu ' . tbgls($n % 1000));
            }
            if ($n < 1000000000) {
                return trim(tbgls((int) ($n / 1000000)) . ' juta ' . tbgls($n % 1000000));
            }
            return (string) $n;
        }
    }
...
<head>
    ...
    <style>
        ...
        *,
        ...
        .print-page-kwitansi:last-of-type {
            page-break-after: auto !important;
            break-after: auto !important;
        }
    ...
    <section class="sheet">
        <div class="inner">
            <table style="width:100%;border-collapse:collapse;margin-bottom:4px;">
                <tr>
                    <td
                        style="width:115px;text-align:center;vertical-align:middle;padding-left:50px;padding-right:10px;">
                    ...
                    <td style="text-align:center;vertical-align:middle;padding-right:5px;">
                        <div class="office-head">
                            ...
                            <div class="kop-text">Website: diskominfo.wonosobokab.go.id email:
                                diskominfo@wonosobokab.go.id</div>
            ...
            <p>Sehubungan dengan Surat Perintah Membayar Langsung (SPM-LS Nomor: {{ $noSpmSipd }}) tanggal
                {{ $tglText }}
            ...
            <p>Bertanggung Jawab secara formal dan material atas kebenaran penggunaan dana tersebut diatas sesuai
                ketentuan yang berlaku.</p>
            <p>Demikian surat Pernyataan ini dibuat untuk melengkapi pernyataan dan persyaratan pengajuan SPP-LS SKPD
                kami.</p>
    ...
    <section class="sheet">
        <div class="inner">
            ...
            <table class="form" style="width:80%;margin-top:28px;">
                <tr>
                    <td style="width:48%;">Bulan</td>
                    <td style="width:3%;">:</td>
                    <td>{{ $bulanTxt }} {{ $tahun }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>SPM – LS yang diajukan Sebesar</td>
                    <td>:</td>
                    <td>Rp. {{ rpls($belanja->total_nilai) }}</td>
                </tr>
                <tr>
                    <td>SPM – LS disahkan</td>
                    <td>:</td>
                    <td>Rp. {{ rpls($belanja->total_nilai) }}</td>
                </tr>
            </table>
    ...
    <section class="sheet">
        <div class="inner">
            ...
            <table class="grid" style="font-size:10px;">
                ...
                @foreach (['Kode Rekening dan Nominasi Belanja Sesuai SPJ', 'Nota Belanja dan Kwitansi Dinas', 'Bukti Setoran Pajak', 'Surat Pengantar SPP GU/TU/UP/LS', 'Ringkasan SPP GU/TU/UP/LS', 'Rincian SPP', 'Surat Perintah Membayar (SPM)', 'Surat Pernyataan Pengajuan SPP GU/TU/UP/LS', 'Surat Pernyataan Tanggung Jawab PA', 'Lembar Verifikasi PPK - SKPD'] as $idx => $item)
                    <tr>
        ...
        <div class="inner">
            ...
            <table class="form" style="width:82%;margin:14px 0;">
                ...
                <tr>
                    <td>Jabatan</td>
                    <td>:</td>
                    <td>Kepala Dinas Komunikasi &amp; Informatika Kabupaten Wonosobo.</td>
                </tr>
            </table>
